...
export class InstituteSelectorModalPage extends OnDestroyMixin implements OnInit {
    ...
    async ngOnInit() {
        ...
        (await this.kreta.getInstituteList()).pipe(untilComponentDestroyed(this)).subscribe(x => {
            this.institutes = x;
