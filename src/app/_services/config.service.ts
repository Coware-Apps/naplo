...
export class ConfigService {
  ...
  public get theme(): string { return this._theme || 'light'; }
  ...
  public get analytics(): boolean { return this._analytics || true; }
  ...
  public get defaultErtekelesTipus(): ErtekelesTipus { return this._defaultErtekelesTipus || ErtekelesTipus.Osztalyzat; }
  ...
  public async onInit() {
    ...
    this._defaultErtekelesTipus = await this.data.getSetting<ErtekelesTipus>("defaultErtekelesTipus").catch(() => null);
  ...
  public async applyTheme(theme?: string, setStatusbar: boolean = true) {
    if (!theme) {
      theme = await this.data.getSetting<string>("theme")
        .catch(() => {
  ...
  private async applyLocale(locale?: string) {
    if (!locale) {
      locale = await await this.data.getSetting<string>("locale")
