...
export class OsComponentsPage implements OnInit, OnDestroy {
  ...
  public componentList = [
    ...
    { name: 'w11k/ngx-componentdestroyed', url: 'https://github.com/w11k/ngx-componentdestroyed' },
    { name: 'Apache Cordova', url: 'https://github.com/apache/cordova-android' },
    { name: 'silkimen/cordova-plugin-advanced-http', url: 'https://github.com/silkimen/cordova-plugin-advanced-http' },
    { name: 'Rareloop/cordova-plugin-app-version', url: 'https://github.com/Rareloop/cordova-plugin-app-version' },
    { name: 'VitaliiBlagodir/cordova-plugin-datepicker', url: 'https://github.com/VitaliiBlagodir/cordova-plugin-datepicker' },
    { name: 'apache/cordova-plugin-file', url: 'https://github.com/apache/cordova-plugin-file' },
    { name: 'apache/cordova-plugin-globalization', url: 'https://github.com/apache/cordova-plugin-globalization' },
    { name: 'apache/cordova-plugin-network-information', url: 'https://github.com/apache/cordova-plugin-network-information' },
    { name: 'EddyVerbruggen/cordova-plugin-safariviewcontroller', url: 'https://github.com/EddyVerbruggen/cordova-plugin-safariviewcontroller' },
    ...
    { name: 'cordova-plugin-firebasex', url: 'https://github.com/dpa99c/cordova-plugin-firebasex' },
  ];
